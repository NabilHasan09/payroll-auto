...
const dummyConsolidatedData = [
  { intern: "John Doe", department: "IT", totalHours: 40, adjustments: 2, flagged: false },
  { intern: "Jane Smith", department: "Marketing", totalHours: 42, adjustments: 1, flagged: true },
      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border border-gray-300 px-4 py-2">Adjustments</th>
            <th className="border border-gray-300 px-4 py-2">Flagged</th>
          </tr>
        </thead>
        <tbody>
          {consolidatedData.map((data) => (
            <tr key={data.intern} className={data.flagged ? "bg-red-100" : ""}>
              <td className="border border-gray-300 px-4 py-2">{data.intern}</td>
              <td className="border border-gray-300 px-4 py-2">{data.department}</td>
              <td className="border border-gray-300 px-4 py-2">{data.totalHours}</td>
              <td className="border border-gray-300 px-4 py-2">{data.adjustments}</td>
              <td className="border border-gray-300 px-4 py-2">{data.flagged ? "Yes" : "No"}</td>
            </tr>
          ))}
        </tbody>
      </table>
